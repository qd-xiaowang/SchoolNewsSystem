<template>
	<div class="crestehelp">
		<h3 style='text-align:center;'>{{id?'编辑':'发布' }}校园新闻</h3>
		<el-form ref="form" :model="article" label-width="80px" size="medium ">
			<el-form-item label="分类">
				<el-radio v-for="(item,id) in lable" :key="id" :class="'page_span_'+id " v-model="article.article_lable"
					:label="item">{{item}}</el-radio>
			</el-form-item>
			<el-form-item label="标题">
				<el-input v-model="article.article_title" useCustomImageHandler @image-added="handleImageAdded">
				</el-input>
			</el-form-item>
			<el-form-item label="简介">
				<el-input type="textarea" :rows="2" placeholder="请输入文章简介" v-model="article.article_introduction">
				</el-input>
			</el-form-item>
			<el-form-item label="内容">
				<vue-editor useCustomImageHandler @image-added="handleImageAdded" v-model="article.article_content">
				</vue-editor>
			</el-form-item>
			<el-form-item>
