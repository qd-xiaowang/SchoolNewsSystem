			...
			<header>
				<div class="container">
					<div class="logo-container">
						<router-link class="tag-line" style="font-size: 24px;color: #000;" to="/">校园新闻系统</router-link>
					</div>
					<!-- Start of Main Navigation -->
					<nav class="main-nav">
						<div class="menu-top-menu-container">
							<ul id="menu-top-menu" >
								<li v-if='logining == 1'  style='padding:0px;'>
									<a @click="closein">登录&nbsp;&nbsp;</a>
								</li>
								<el-dropdown v-else>
									<a style="color: #c1cad1;cursor: pointer;">
										{{nickname}}
									</a>
									<el-dropdown-menu slot="dropdown">
										<el-dropdown-item>
											<router-link to="/admin/myself" tag="a"
												exact-active-class="current-menu-item">个人中心</router-link>
										</el-dropdown-item>
